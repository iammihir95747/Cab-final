...
const Services = () => {
  ...
  <meta
    name="description"
    content="Book reliable and affordable taxi service from Gujarati. Best cab booking with experienced drivers, one-way and round-trip options, 24/7 customer support."
  />
